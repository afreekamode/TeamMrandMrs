...
<div style="width:300px;float:left;"><button type="submit" name="login" onclick="user_log();" class="general_button">Login</button><a href="signup.php?signup" class="general_button">Sign Up</a><br></button>	
